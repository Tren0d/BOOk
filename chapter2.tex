...
\end{problem}
\begin{problem}
In a set of $17$ visually identical coins there are two counterfeit coins that differ in weight from the genuine ones. It is known that the combined weight of the two counterfeit coins equals twice the weight of a genuine coin. Is it always possible to determine the pair of counterfeit coins using $5$ weighings on a balance scale without weights? (It is not required to determine which of the counterfeit coins is heavier.)
\end{problem}
